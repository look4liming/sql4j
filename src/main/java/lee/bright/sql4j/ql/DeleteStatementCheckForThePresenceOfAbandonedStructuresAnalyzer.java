 ...
 * @author Bright Lee
 */
public final class DeleteStatementCheckForThePresenceOfAbandonedStructuresAnalyzer {
	
	private SourceCode sourceCode;
	private DeleteStatement deleteStatement;
	
	public DeleteStatementCheckForThePresenceOfAbandonedStructuresAnalyzer(
	...
	private void checkColumnInSearchCondition(NameChain column) {
		if (column.size() > 1) {
			throw Sql4jException.getSql4jException(sourceCode, column.getBeginIndex(), 
					"The column name must be a simple name.");
		}
