 ...
 * @author Bright Lee
 */
public final class UpdateStatementDetectTableNameConflictsAnalyzer {
	
	private SourceCode sourceCode;
	private UpdateStatement updateStatement;
	
	public UpdateStatementDetectTableNameConflictsAnalyzer(
